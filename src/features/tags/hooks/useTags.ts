...
export const useCreateTagGroup = createMutationHook(TagsApi.useCreateTagGroup, [
  TagsApi.getGetTagGroupsQueryKey(),
]);

export const useUpdateTagGroup = createMutationHook(TagsApi.useUpdateTagGroup, [
  TagsApi.getGetTagGroupsQueryKey(),
]);

export const useDeleteTagGroup = createMutationHook(TagsApi.useDeleteTagGroup, [
  TagsApi.getGetTagGroupsQueryKey(),
]);
