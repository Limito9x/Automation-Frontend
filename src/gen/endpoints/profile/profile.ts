...
export const updateProfile = (
 ...
 signal?: AbortSignal
      ...
      data: updateProfileCommand, signal
    },
      );
    }
...
export const getUpdateProfileMutationOptions = <TError = void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateProfile>>, TError,{data: UpdateProfileCommand}, TContext>, }
...
const {mutation: mutationOptions} = options ?
 ...
 signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: updateAvatarCommand, signal
    },
      );
    }
...
export const getUpdateAvatarMutationOptions = <TError = ErrorResponse | void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateAvatar>>, TError,{data: UpdateAvatarCommand}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof updateAvatar>>, TError,{data: UpdateAvatarCommand}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateAvatar>>, {data: UpdateAvatarCommand}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useUpdateAvatar = <TError = ErrorResponse | void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateAvatar>>, TError,{data: UpdateAvatarCommand}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
 ...
 signal?: AbortSignal
      ...
      return customInstance<string>(
      {url: `/api/profile/change-password`, method: 'PUT',
      headers: {'Content-Type': 'application/json', },
...
export const getChangePasswordMutationOptions = <TError = ErrorResponse | void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof changePassword>>, TError,{data: ChangePasswordCommand}, TContext>, }
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export const useChangePassword = <TError = ErrorResponse | void,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof changePassword>>, TError,{data: ChangePasswordCommand}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
