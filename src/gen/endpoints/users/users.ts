...
export const backendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatus =
  (
...
export const getBackendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatusMutationOptions =
  <TError = ErrorResponse | void, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<
      Awaited<
        ReturnType<
          typeof backendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatus
        >
      >,
      TError,
      { data: BulkUpdateUserStatusCommand },
  ...
  > => {
    const mutationKey = [
      "backendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatus",
    ];
    const { mutation: mutationOptions } = options
      ? options.mutation &&
        "mutationKey" in options.mutation &&
    ...
    > = (props) => {
      ...
      return backendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatus(
        data,
      );
    };
...
export type BackendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatusMutationResult =
  NonNullable<
    Awaited<
      ReturnType<
        typeof backendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatus
    ...
    >
  >;
export type BackendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatusMutationBody =
  BulkUpdateUserStatusCommand;
export type BackendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatusMutationError =
  ErrorResponse | void;

export const useBackendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatus =
  ...
  > => {
    return useMutation(
      getBackendModularIdentityFeaturesUsersBulkUpdateStatusBulkUpdateUserStatusMutationOptions(
        options,
      ),
      queryClient,
    );
